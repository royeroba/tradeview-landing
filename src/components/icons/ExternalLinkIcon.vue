...
<svg xmlns="http://www.w3.org/2000/svg" width="16" height="14.222" viewBox="0 0 16 14.222">
  <path id="Icon_awesome-external-link-alt" data-name="Icon awesome-external-link-alt" d="M16,.667V4.222a.667.667,0,0,1-1.138.471L13.87,3.7,7.106,10.466a.667.667,0,0,1-.943,0l-.629-.629a.667.667,0,0,1,0-.943L12.3,2.13l-.992-.992A.667.667,0,0,1,11.778,0h3.555A.667.667,0,0,1,16,.667ZM11.306,7.522l-.444.444a.667.667,0,0,0-.2.471v4.007H1.778V3.556H9.111a.667.667,0,0,0,.471-.2l.444-.444a.667.667,0,0,0-.471-1.138H1.333A1.333,1.333,0,0,0,0,3.111v9.778a1.333,1.333,0,0,0,1.333,1.333h9.778a1.333,1.333,0,0,0,1.333-1.333v-4.9A.667.667,0,0,0,11.306,7.522Z" fill="#363636"/>
</svg>
</template>
