...
import ItemC from '@/components/icons/ItemC.vue'
...
<template>
  ...
  <main>
    <section id="impression">
      <div id="devices">
        <img id="devices_img" src="../assets/landing_devices.png" />
      </div>
      <div id="community">
        <CommunityIcon />
        <h1>
          Tradeview’s <strong>CommuniTraders</strong> software lets <br />
